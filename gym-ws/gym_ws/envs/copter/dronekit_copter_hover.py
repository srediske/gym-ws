...
class dronekit_CopterEnv(gazebo_env.GazeboEnv, AutoTest):
    ...
    def __init__(self):
        ...
        self._takeoff(5) # First takeoff, not really necessary and does not contribute to the RL
        self._seed()
    ...
    def _launch_apm(self):
        ...
        subprocess.Popen(["xterm","-e", sim_vehicle_py,"-j4","-v","ArduCopter","-f","gazebo-iris", "--console"]) # add "--console" for Copter GUI
    ...
    def step(self, action):
        ...
        if action == 0:  # FORWARD : {Roll, Pitch, Throttle, Yaw}
            self.vehicle.channels.overrides = {'1':1500,'2':1470,'3':1510,'4':None}
        elif action == 1:  # LEFT
            self.vehicle.channels.overrides = {'1': 1470, '2': 1500, '3': 1510, '4': None}
        elif action == 2:  # RIGHT
            self.vehicle.channels.overrides = {'1': 1530, '2': 1500, '3': 1510, '4': None}
        elif action == 3:  # BACKWARDS
            self.vehicle.channels.overrides = {'1': 1500, '2': 1530, '3': 1510, '4': None}
